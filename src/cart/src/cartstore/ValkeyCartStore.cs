...
public class ValkeyCartStore : ICartStore
{
    ...
    public ValkeyCartStore(ILogger<ValkeyCartStore> logger, string valkeyAddress = "correct_redis_host")
    {
        _logger = logger;
        // Serialize empty cart into byte array.
        var cart = new Oteldemo.Cart();
        _emptyCartBytes = cart.ToByteArray();
        _connectionString = "correct_redis_host,ssl=false,allowAdmin=true,abortConnect=false";
